...

;;;### (autoloads nil "dynamic-spaces" "dynamic-spaces.el" (0 0 0
;;;;;;  0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dynamic-spaces" '("dynamic-spaces-")))
